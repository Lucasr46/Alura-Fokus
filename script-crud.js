...
const btnRomverTodas = document.querySelector('#btn-remover-todas')
...
function criarElementoTarefa(tarefa){
    ...
    botao.onclick = () =>{
        ...
        //console.log('Task new descripiton:', novaDescricao)
        if (novaDescricao){
...
btnRomverTodas.onclick = () => removerTarefas(false)
